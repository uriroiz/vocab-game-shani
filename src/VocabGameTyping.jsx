...
const VocabGameTyping = ({ onBackToHome }) => {
  ...
  useEffect(() => {
    ...
    const loadDefaultWords = async () => {
      try {
        const response = await fetch('/English-Hebrew-Words_Shani.csv');
        if (response.ok) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-400 to-blue-400 flex items-center justify-center p-3 sm:p-4">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 max-w-2xl w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
            <button
              onClick={startGame}
              className="w-full sm:w-auto px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-lg sm:text-xl md:text-2xl font-bold rounded-xl sm:rounded-2xl hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center"
            >
            ...
            {onBackToHome && (
              <button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gray-500 text-white text-base sm:text-lg font-bold rounded-xl sm:rounded-2xl hover:bg-gray-600 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center"
              >
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 max-w-2xl w-full">
          ...
          <div className="flex flex-col gap-3">
            ...
            {onBackToHome && (
              <button
                onClick={onBackToHome}
                className="w-full px-6 sm:px-8 py-3 bg-gray-500 text-white text-base sm:text-lg font-bold rounded-xl hover:bg-gray-600 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center"
              >
                <Home className="w-5 h-5 mr-2" />
                Back to Home
              </button>
